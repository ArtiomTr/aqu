...
export const loadAndResolveAquConfig = async (configPath?: string): Promise<Array<AquOptions> | undefined> => {
    ...
    const standardConfigs = await Promise.all([getDefaultAquConfig(), getAquOptionsFromPackage()]);
